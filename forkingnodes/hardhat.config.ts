...
console.log("started forking node rpc:", process.env.FORKING_RPC_URL, "chainID:", process.env.FORKING_CHAIN_ID);
        ...
        ...(
          process.env.PRIVATE_KEY ? [
            // NOTE: chanyutl - find accounts field document in https://hardhat.org/hardhat-network/reference/#accounts
            {
              ...
              balance: parseEther(process.env.ETH_BALANCE || '1000000').toString(), // mimic balance
            }
          ] : []
        ),
      ],
